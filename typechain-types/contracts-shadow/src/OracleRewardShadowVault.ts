...
export interface OracleRewardShadowVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface OracleRewardShadowVault extends BaseContract {
  connect(runner?: ContractRunner | null): OracleRewardShadowVault;
  waitForDeployment(): Promise<this>;

  interface: OracleRewardShadowVaultInterface;
