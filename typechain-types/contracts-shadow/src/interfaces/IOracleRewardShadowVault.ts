...
export declare namespace IOracleRewardShadowVault {
  ...
  export type UserInfoStruct = {
    ...
    rewardDebtInfo: IOracleRewardShadowVault.RewardDebtInfoStruct[];
  };

  export type UserInfoStructOutput = [
    phantomAmount: bigint,
    rewardDebtInfo: IOracleRewardShadowVault.RewardDebtInfoStructOutput[]
  ] & {
    phantomAmount: bigint;
    rewardDebtInfo: IOracleRewardShadowVault.RewardDebtInfoStructOutput[];
  };
...
export interface IOracleRewardShadowVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export namespace PoolUpdatedEvent {
  ...
  export type OutputTuple = [timestamp: bigint, accRewardsPerShare: bigint];
  export interface OutputObject {
    timestamp: bigint;
...
export interface IOracleRewardShadowVault extends BaseContract {
  connect(runner?: ContractRunner | null): IOracleRewardShadowVault;
  waitForDeployment(): Promise<this>;

  interface: IOracleRewardShadowVaultInterface;
  ...
  getPendingRewards: TypedContractMethod<
    [user: AddressLike],
    [IOracleRewardShadowVault.UserRewardStructOutput[]],
    "view"
  >;
  ...
  getUserInfo: TypedContractMethod<
    [user: AddressLike],
    [IOracleRewardShadowVault.UserInfoStructOutput],
    "view"
  >;
