...
export interface IShadowVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IShadowVault extends BaseContract {
  connect(runner?: ContractRunner | null): IShadowVault;
  waitForDeployment(): Promise<this>;

  interface: IShadowVaultInterface;
