...
export interface IRamsesV3PoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_advancePeriod"
      | "burn"
  ...
  encodeFunctionData(
    functionFragment: "_advancePeriod",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface IRamsesV3Pool extends BaseContract {
  connect(runner?: ContractRunner | null): IRamsesV3Pool;
  waitForDeployment(): Promise<this>;

  interface: IRamsesV3PoolInterface;
  ...
  _advancePeriod: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "_advancePeriod"
