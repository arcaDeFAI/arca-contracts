...
export interface IRamsesV3PoolImmutablesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "factory"
      | "fee"
...
export interface IRamsesV3PoolImmutables extends BaseContract {
  connect(runner?: ContractRunner | null): IRamsesV3PoolImmutables;
  waitForDeployment(): Promise<this>;

  interface: IRamsesV3PoolImmutablesInterface;
