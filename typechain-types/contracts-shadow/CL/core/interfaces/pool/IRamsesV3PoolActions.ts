...
export interface IRamsesV3PoolActionsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      | "collect"
...
export interface IRamsesV3PoolActions extends BaseContract {
  connect(runner?: ContractRunner | null): IRamsesV3PoolActions;
  waitForDeployment(): Promise<this>;

  interface: IRamsesV3PoolActionsInterface;
