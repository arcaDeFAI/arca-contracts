...
export interface IRamsesV3PoolEventsInterface extends Interface {
  getEvent(
...
export interface IRamsesV3PoolEvents extends BaseContract {
  connect(runner?: ContractRunner | null): IRamsesV3PoolEvents;
  waitForDeployment(): Promise<this>;

  interface: IRamsesV3PoolEventsInterface;
