...
export interface IRamsesV3PoolStateInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IRamsesV3PoolState extends BaseContract {
  connect(runner?: ContractRunner | null): IRamsesV3PoolState;
  waitForDeployment(): Promise<this>;

  interface: IRamsesV3PoolStateInterface;
