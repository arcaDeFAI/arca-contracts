...
export interface IRamsesV3PoolDerivedStateInterface extends Interface {
  getFunction(
...
export interface IRamsesV3PoolDerivedState extends BaseContract {
  connect(runner?: ContractRunner | null): IRamsesV3PoolDerivedState;
  waitForDeployment(): Promise<this>;

  interface: IRamsesV3PoolDerivedStateInterface;
