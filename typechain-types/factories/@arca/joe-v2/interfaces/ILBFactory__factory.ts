...
import type {
  ILBFactory,
  ILBFactoryInterface,
} from "../../../../@arca/joe-v2/interfaces/ILBFactory";
...
export class ILBFactory__factory {
  static readonly abi = _abi;
  static createInterface(): ILBFactoryInterface {
    return new Interface(_abi) as ILBFactoryInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ILBFactory {
    return new Contract(address, _abi, runner) as unknown as ILBFactory;
  }
}
