...
import type {
  IShadowVault,
  IShadowVaultInterface,
} from "../../../../contracts-shadow/src/interfaces/IShadowVault";
...
export class IShadowVault__factory {
  static readonly abi = _abi;
  static createInterface(): IShadowVaultInterface {
    return new Interface(_abi) as IShadowVaultInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IShadowVault {
    return new Contract(address, _abi, runner) as unknown as IShadowVault;
  }
}
