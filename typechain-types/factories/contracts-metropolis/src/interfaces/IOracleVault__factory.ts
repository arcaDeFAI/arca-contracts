...
import type {
  IOracleVault,
  IOracleVaultInterface,
} from "../../../../contracts-metropolis/src/interfaces/IOracleVault";
...
export class IOracleVault__factory {
  static readonly abi = _abi;
  static createInterface(): IOracleVaultInterface {
    return new Interface(_abi) as IOracleVaultInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IOracleVault {
    return new Contract(address, _abi, runner) as unknown as IOracleVault;
  }
}
