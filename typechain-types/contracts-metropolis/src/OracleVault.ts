...
export interface OracleVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface OracleVault extends BaseContract {
  connect(runner?: ContractRunner | null): OracleVault;
  waitForDeployment(): Promise<this>;

  interface: OracleVaultInterface;
