...
export interface IOracleHelperInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IOracleHelper extends BaseContract {
  connect(runner?: ContractRunner | null): IOracleHelper;
  waitForDeployment(): Promise<this>;

  interface: IOracleHelperInterface;
