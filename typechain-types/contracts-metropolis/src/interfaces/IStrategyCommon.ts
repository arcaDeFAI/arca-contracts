...
export interface IStrategyCommonInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getAumAnnualFee"
      | "getBalances"
...
export interface IStrategyCommon extends BaseContract {
  connect(runner?: ContractRunner | null): IStrategyCommon;
  waitForDeployment(): Promise<this>;

  interface: IStrategyCommonInterface;
