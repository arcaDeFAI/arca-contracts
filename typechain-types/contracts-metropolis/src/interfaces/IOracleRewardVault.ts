...
export interface IOracleRewardVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IOracleRewardVault extends BaseContract {
  connect(runner?: ContractRunner | null): IOracleRewardVault;
  waitForDeployment(): Promise<this>;

  interface: IOracleRewardVaultInterface;
