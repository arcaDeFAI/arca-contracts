...
export interface IMetropolisStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getAumAnnualFee"
      | "getBalances"
...
export interface IMetropolisStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): IMetropolisStrategy;
  waitForDeployment(): Promise<this>;

  interface: IMetropolisStrategyInterface;
