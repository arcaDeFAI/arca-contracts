...
export interface MockMetropolisStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getAumAnnualFee"
      | "getBalances"
...
export interface MockMetropolisStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): MockMetropolisStrategy;
  waitForDeployment(): Promise<this>;

  interface: MockMetropolisStrategyInterface;
