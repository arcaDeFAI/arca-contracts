 ...
 * @dev Minimal mock implementation of Metropolis strategy for testing
 */
contract MockMetropolisStrategy is IStrategyCommon {
    ...
    // Additional functions for Oracle Helper access
