...
/**
 * @title Dragonswap Price Helper Wrapper
 * @notice Wrapper contract to expose DragonswapPriceHelper library functions as external view functions
 * @dev This contract makes it possible to call library functions from JavaScript/TypeScript
 */
contract DragonswapPriceHelperWrapper {
    /**
    ...
    function getPoolSpotPrice(
        ...
        return
            DragonswapPriceHelper.getPoolSpotPrice(
                pool,
                isTokenX,
                decimalsX,
                decimalsY
    ...
    function getPoolTWAPPrice(
        ...
        return
            DragonswapPriceHelper.getPoolTWAPPrice(
                pool,
                isTokenX,
                twapInterval,
                decimalsX,
