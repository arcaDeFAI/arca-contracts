    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-arca-secondary text-sm sm:text-base">
          Stake METRO and X33 tokens to earn rewards
        </p>
      </div>
      {/* Global Stats */}
            ...
            <CardContent className="space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {stakingTiers.map((tier) => (
                        ...
                        >
                          ...
                          <div className="text-arca-primary text-xs">
                            {tier.multiplier}x
                          </div>
                          <div className="text-arca-secondary text-xs">
                            {tier.penaltyRate}% penalty
                          </div>
                        </button>
                      ))}
                    </div>
                  ...
                  <div className="bg-arca-bg rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="text-arca-primary">
                          {stakingTiers[selectedTier].multiplier}x
                        </span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <span className="text-white">
                          {stakingTiers[selectedTier].lockPeriod} days
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-arca-secondary">
                        ...
                        <span className="text-red-400">
                          {stakingTiers[selectedTier].penaltyRate}%
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="text-arca-secondary text-xs mt-1">
                  Balance:{" "}
                  <span className="text-arca-primary">
                    {selectedTab === "metro" ? "10,000 METRO" : "5,000 X33"}
                  </span>
                </div>
              </div>
              ...
              {selectedTab === "metro" && stakeAmount && (
                <div className="bg-arca-bg rounded-lg p-4">
                  <div className="text-arca-secondary font-medium mb-2">
                    You Will Receive
                  </div>
                  <div className="text-arca-primary text-2xl font-bold">
                    {(
                      parseFloat(stakeAmount) *
                      stakingTiers[selectedTier].multiplier
                    ).toLocaleString()}{" "}
                    nMETRO
                  </div>
                </div>
              ...
              {selectedTab === "x33" && stakeAmount && (
                <div className="bg-arca-bg rounded-lg p-4">
                  ...
                  <div className="text-arca-secondary text-sm mt-1">
                    1:1 ratio, no lock period
                  </div>
                </div>
              )}
                ...
                {selectedTab === "metro" ? (
                  mockMetroPositions.length > 0 ? (
                    mockMetroPositions.map((position) => (
                      <div
                        key={position.id}
                        className="bg-arca-bg rounded-lg p-4"
                      >
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <Badge
                            variant="secondary"
                            className="bg-arca-primary/20 text-arca-primary"
                          >
                    ...
                    <div className="text-center py-8">
                      <div className="text-arca-secondary">
                        No METRO positions found
                      </div>
                      <div className="text-arca-secondary text-sm">
                        Stake METRO tokens to get started
                      </div>
                    </div>
                  )
                  ...
                  <div className="text-center py-8">
                    <div className="text-arca-secondary">
                      No X33 positions found
                    </div>
                    <div className="text-arca-secondary text-sm">
                      Stake X33 tokens to get started
                    </div>
                  </div>
                )}
              </div>
