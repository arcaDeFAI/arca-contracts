...
export const LBP_ABI = [
  ...
  { inputs: [], name: "LBToken__LengthMismatch", type: "error" },
  {
  ...
  { inputs: [], name: "Uint128x128Math__PowUnderflow", type: "error" },
  { inputs: [], name: "Uint256x256Math__MulDivOverflow", type: "error" },
  { inputs: [], name: "Uint256x256Math__MulShiftOverflow", type: "error" },
  { inputs: [], name: "Uint24Library__AddOverflow", type: "error" },
  { inputs: [], name: "Uint24Library__SubUnderflow", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
