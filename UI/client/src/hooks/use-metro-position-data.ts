...
// Simple ABI for the essential calls we need
const LB_PAIR_ABI = [
  {
    inputs: [],
    name: "getActiveId",
...
// Complete Metro Strategy ABI - includes getRange returning int32 values
const METRO_STRATEGY_ABI = [
  {
    inputs: [
      {
  ...
  { inputs: [], name: "BaseVault_WithdrawLocked", type: "error" },
  { inputs: [], name: "BaseVault__AlreadyFlaggedForShutdown", type: "error" },
  {
  ...
  { inputs: [], name: "BaseVault__InsufficientShares", type: "error" },
  ...
  { inputs: [], name: "BaseVault__OnlyOperators", type: "error" },
  ...
  { inputs: [], name: "OracleVault__GracePeriodNotOver", type: "error" },
  { inputs: [], name: "OracleVault__InvalidInterval", type: "error" },
  { inputs: [], name: "OracleVault__InvalidPrice", type: "error" },
  { inputs: [], name: "OracleVault__InvalidTimestamps", type: "error" },
  { inputs: [], name: "OracleVault__PriceDeviation", type: "error" },
  { inputs: [], name: "OracleVault__SequencerDown", type: "error" },
  { inputs: [], name: "OracleVault__StalePrice", type: "error" },
  { inputs: [], name: "TokenHelper__NativeTransferFailed", type: "error" },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "contract IOracleHelper", name: "", type: "address" },
    ],
    stateMutability: "pure",
    type: "function",
  },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint24", name: "heartbeatX", type: "uint24" },
          { internalType: "uint24", name: "heartbeatY", type: "uint24" },
          {
            internalType: "uint256",
            name: "deviationThreshold",
            type: "uint256",
          },
          { internalType: "bool", name: "twapPriceCheckEnabled", type: "bool" },
          { internalType: "uint40", name: "twapInterval", type: "uint40" },
        ],
  ...
  },
  {
    ...
    name: "getStrategy",
    outputs: [
      { internalType: "contract IStrategyCommon", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "uint256", name: "phantomAmount", type: "uint256" },
          {
            components: [
              {
...
// This hook would integrate with Metro's position tracking
// For now, returning mock data structure

export function useMetroPositionData(vaultName: string) {
  // Mock implementation - replace with actual Metro integration
  const mockData = {
    activeId: 8388608,
    lowerBin: 8388600,
    upperBin: 8388616,
